...
def resnet_layer(inputs,
    ...
    :param num_filters: Conv2D number of filters
    :param kernel_size: Conv2D square kernel dimensions
    :param strides: Conv2D square stride dimensions
...
def resnet_v1(input_shape,depth,num_classes=10):
    ...
    :param num_classes: number of classes (CIFAR10 has 10)
